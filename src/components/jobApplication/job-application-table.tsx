...
const JobApplicationTable: React.FC<LeadsJobProps> = ({
  leads,
  onStatusChange,
}) => {
          ...
          <TableRow key={lead.id}>
            <TableCell>
              <Select
                ...
                onValueChange={(value) =>
                  handleChange(lead.JobApplication?.leadsId, value)
                }
              >
                <SelectTrigger
                  className={
                ...
                <SelectContent>
                  ...
                  <SelectItem
                    className={
                      lead.JobApplication?.status == "Rejected"
                        ? "hidden"
                        : undefined
                    }
                    value="Rejected"
                  ...
                  <SelectItem
                    className={
                      lead.JobApplication?.status == "Drop"
                        ? "hidden"
                        : undefined
                    }
                    value="Drop"
